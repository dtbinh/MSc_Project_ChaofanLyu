...
input_size = 21
output_size = 4
hid_size = [input_size, 17, 5 , output_size]
...
with tf.variable_scope("layer1"):
    ...
    layer1 = tf.nn.sigmoid(tf.add(tf.matmul(x,w1), b1), name='layer1_nodes')
...
with tf.variable_scope("layer2"):
    ...
    layer2 = tf.nn.softsign(tf.add(tf.matmul(tf.concat([x, layer1], axis=1),w2), b2), name='layer2_nodes')
...
loss_train_log = []
loss_test_log = []
saved_model_filename = "./Model_test1/test_3HL_model.ckpt"
